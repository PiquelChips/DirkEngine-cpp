...
void DirkEngine::createCommandBuffer() {
...
void DirkEngine::createSyncObjects() {
...
void DirkEngine::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
